CREATE procedure [DBLog].[usp_Add_User] @UserName varchar(50), @Password varchar(50), @rolename varchar(50), @emailAddress varchar(600)
as
	set nocount on
	...
	select @UserName, 1, @encryptedPassword, @emailAddress
